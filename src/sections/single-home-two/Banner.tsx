...
const Banner: React.FC = () => {
    ...
    const sliderItems = [
        {
            id: 1,
            title: 'Recruitment & Consulting Experts',
            titleHighlight: 'Hire Smarter. Hire Faster',
            description: 'DataPulse Technologies delivers end-to-end recruitment and consulting solutions across Australia. We help businesses find skilled professionals, manage Labour Market Testing (LMT), and build strong, future-ready teams with speed and precision.',
                                ...
                                <div className="container">
                                    <div className="main-slider__content">
                                        <div className="main-slider__title-box">
                                            <h1 className="main-slider__title">Simple Solutions <br /> for <span>Your Business <br />
                                                Success</span></h1>
