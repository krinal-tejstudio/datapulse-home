...
import ctaImg from '../../assets/images/custom/cta.png';
                    ...
                    <div className="cta-one__inner">
                        ...
                        <div className="cta-one__inner-content">
                            ...
                            <h3 className="cta-one__title">
                                Start your recruitment journey<br /> with DataPulse Technologies today.
                            </h3>
                            ...
                            <div className="why-choose-two__right">
                                <div className="section-title-two text-left sec-title-animation animation-style2">
                                    ...
                                    <h2 className="section-title-two__title title-animation">
                                        <TextAnimation text='Why Businesses Trust DataPulse for' textColor='black' isSpan={false} />
                                        <TextAnimation text='Recruitment & Workforce Solutions' textColor='#00C2A8' isSpan={false} />
                                ...
                                <ul className="list-unstyled why-choose-two__points">
                                    <li>
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                            We ensure proper Labour Market Testing (LMT) processes to help 
                                            businesses meet Australian government requirements and hire 
                                            skilled international talent efficiently.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div className="content">
                                            <h4>
                                                <Link to="/about">
                                                Skilled Talent Recruitment & Consulting
                                                </Link>
                                            </h4>
                                            <p>
                                            Our expert team connects employers with qualified professionals 
                                            and provides workforce consulting solutions tailored to business 
