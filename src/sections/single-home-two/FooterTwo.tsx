                    ...
                    <div className="newsletter-two__inner">
                        <div className="newsletter-two__left">
                            ...
                            <p className="newsletter-two__text">
                                Stay updated with labour market news, hiring insights, and <br/> workforce solutions from DataPulse Technologies.
                            </p>
                        </div>
                                        ...
                                        <div className="footer-widget-two__about">
                                            ...
                                            <ul className="footer-widget-two__get-in-touch-list list-unstyled">
                                                ...
                                                <li>
                                                    ...
                                                    <div className="text">
                                                        <p>
                                                            <a href="mailto:dan@datapulsetech.com.au<br/>
admin@datapulsetech.com.au">dan@datapulsetech.com.au<br/>
admin@datapulsetech.com.au</a>
                                                        </p>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div className="text">
                                                        <p>
                                                            <a href="tel:001234568900">+61 452 263 158</a>
                                                        </p>
                                                    </div>
                                                </li>
                                            </ul>
