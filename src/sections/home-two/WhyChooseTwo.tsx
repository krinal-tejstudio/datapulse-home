                            ...
                            <div className="why-choose-two__right">
                                <div className="section-title-two text-left sec-title-animation animation-style2">
                                    ...
                                    <h2 className="section-title-two__title title-animation">
                                        <TextAnimation text='Why Businesses Trust Data Pulse' textColor='black' isSpan={false} />
                                        <TextAnimation text='for Recruitment & Workforce' textColor='#00C2A8' isSpan={false} />
                                    ...
                                    <li>
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                                ...
                                                businesses meet Australian government requirements and hire skilled 
