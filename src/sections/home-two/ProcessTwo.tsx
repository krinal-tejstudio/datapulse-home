      ...
      <div className="container">
        ...
        <div className="section-title-two text-center sec-title-animation animation-style1">
          <div className="section-title-two__tagline-box justify-content-center">
            ...
            <span className="section-title-two__tagline">Our Working Process</span>
          </div>
          <h2 className="section-title-two__title title-animation">
            <TextAnimation text='Our Structured Recruitment and Labour' textColor='black' isSpan={false} />
            <TextAnimation text='Market Testing Process' textColor='#00C2A8' isSpan={false} />
